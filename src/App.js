    ...
    <div>
        ...
        <section className="max-w-3xl mx-auto text-center">
          <div className="bg-[#d9e5d3] p-6 rounded-lg">
            ...
            <p className="text-gray-700 text-justify">
              Niech czas płynie wolniej, a każdy kęs będzie przyjemnością, która
              zagości w Twoich myślach na dłużej. Przyjdź do naszej przestrzeni,
              gdzie możesz odetchnąć, poczuć się swobodnie i na chwilę zapomnieć
              o codzienności. Zabierz ze sobą bliskich, a my zadbamy o to by
              każda spędzoona chwila była pełna smaku i relaksu.
            </p>
          </div>
        </section>
        <Menu />
      ...
      <footer className="bg-white/70 bg-footer-texture py-6">
        <div className="flex justify-center gap-4">
          ...
          <a href="#">
            <img src="icon-twitter.png" alt="Twitter" className="w-8 h-8" />
          </a>
        </div>
      </footer>
    </div>
